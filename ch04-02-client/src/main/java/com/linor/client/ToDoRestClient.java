...
import com.linor.client.error.ToDoErrorHandler;
...
public class ToDoRestClient {
	...
	public Iterable<ToDo> findAll() throws URISyntaxException{
		RequestEntity<Iterable<ToDo>> requestEntity = 
				new RequestEntity<Iterable<ToDo>>(HttpMethod.GET, 
	...
	public ToDo upsert(ToDo toDo) throws URISyntaxException{
		...
		if(responseEntity.getStatusCode() == HttpStatus.CREATED) {
			return restTemplate.getForObject(responseEntity.getHeaders().getLocation(), 
					ToDo.class);
		}
		return null;
	}
	...
	public ToDo setCompleted(String id) throws URISyntaxException{
		Map<String, String> params = new HashMap<>();
		params.put("id", id);
		restTemplate.postForEntity(properties.getUrl() + properties.getBasePath() + 
