...
public class TodoRepository implements CommonRepository<ToDo> {
	...
	public ToDo findById(String id) {
		try {
			Map<String, String> namedParamters = Collections.singletonMap("id", id);
			return this.jdbcTemplate.queryForObject(SQL_QUERY_FIND_BY_ID, namedParamters, toDoRowMapper);
